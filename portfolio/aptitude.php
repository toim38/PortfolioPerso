...
<section class="rapport avec le matos">
<div class="alert alert-secondary" role="alert">
<h1>RAPPORT AVEC LE MATERIEL</h1>

<div class="text">
<article>
<p> Le terrain serait donc d’abord une matière, formée à la suite de processus constitutifs longs, complexes et toujours inachevés,</p> 
...
<p>[2]Le sens que je donne ici à territoire n’est pas nécessairement…</p>
<p>, puisqu’il s’agit d’un objet, parfois d’un lieu, parfois encore, le plus souvent, </p>
<p>des deux, précisément délimité par celui qui a l’ambition de l’étudier, et qui, de ce fait, </p>
<p>a un projet (de recherche) pour lui et, ce n’est pas le moindre des problèmes à résoudre, se projette sur lui.</p>
...
<div class="alert alert-secondary" role="alert">
    <h2>RAPPORT HUMAIN</h2>

    <div class="text">
<p>Il est considéré que les relations humaines sont essentielles au développement individuel et intellectuel de chaque être humain,</p>
...
<p> Les relations humaines impliquent, nécessairement, au moins deux individus.</p>


    </div>
</div>
<div class="picture">
<img src="photo/images2.jpg" alt="">
