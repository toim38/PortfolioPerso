...
<div class="container">
  ...
  <?= $successmsg;?>
    ...
    <div class="form-group">
      <label for="formGroupExampleInput" >poste</label>
      <?=$msgPoste ?>
    ...
    <div class="form-group">
      ...
      <?=$msgDescription?>
      <textarea name="description" class="form-control" id="validationTextarea" placeholder=" example textarea">
      <?php  if (isset($_GET['action']) && $_GET['action'] == 'modifier' && isset($_GET['id'])){ echo  $xp_modif['description']; } else { echo ""; }?>
      </textarea>
    </div>
  
    <div class="form-group">
      <label for="formGroupExampleInput" >entreprise</label>
      <?=$msgEntreprise?>
      <input type="text" class="form-control" name="entreprise" id="formGroupExampleInput" placeholder="appellation" value="<?php  if (isset($_GET['action']) && $_GET['action'] == 'modifier' && isset($_GET['id'])){ echo  $xp_modif['entreprises']; } else { echo ""; }?>">
    </div>
